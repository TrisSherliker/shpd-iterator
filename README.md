...
An experiment using Android Developer Bridge `adb` to control a USB-connected phone. It controls a game by automated tapping, which is a usefl low-risk playground.
